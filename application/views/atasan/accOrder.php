                    ...
                    <form action="#" id="form-tambah">
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="nama_pegawai" value="<?= $nama ?>">                                
                            </div>
                            <div class="mb-3">
...
<script type='text/javascript'>  
    var save_method;
     $(document).ready(function() {
        ...
        ajax: "<?= base_url("index.php/order/dataOrderAtasan")?>",
        columns: [{
            data: 'no'
            },
            {
    ...
    function changeStatus(id_order, status_order)
    {
        if (status_order == 1){
            var status_order = 0;
        } else {
        ...
        var id = id_order;
        $.ajax({
            url : "<?php echo site_url('index.php/order/changeStatus')?>",
            method: "POST",
            data : {
