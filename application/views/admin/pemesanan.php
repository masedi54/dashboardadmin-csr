...
<!-- Form ADD Penyetuju-->
<div class="modal" tabindex="-1" id="form-add" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                <!-- <span aria-hidden="true">&times;</span></button> -->
              ...
              <form action="#" id="form-add">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" id="btnSimpan" onclick="add()" class="btn btn-primary" data-dismiss="modal">Simpan</button>
                </div>
              </form>
            </div>
...
<script type='text/javascript'>  
    var save_method;
     $(document).ready(function() {
        ...
        ajax: "<?= base_url("index.php/PemesananAdmin/dataPemesanan")?>",
        columns: [{
            data: 'no'
            },
            {
    ...
    // Modal ADD PENYETUJU
    function addPenyetuju(id_order) {
        $.ajax({
        url: "<?php echo site_url('index.php/PemesananAdmin/add') ?>/" + id_order,
        type: "POST",
        dataType: "JSON",
        ...
        success: function(data) {
          ...
          $('#form-add').modal('show'); // reset form modal
        },
        error: function(jqXHR, textStatus, errorThrown) {
          alert('Error get data from ajax');
        }
    ...
    $.ajax({
      url: "<?php echo base_url('index.php/PemesananAdmin/tambahPenyetuju') ?>",
      type: 'POST',
      dataType: 'JSON',
