...
<head>
  ...
  <!-- Page CSS -->
  <!-- Page -->
  <link rel="stylesheet" href="<?php echo base_url()?>assets/css/page-auth.css" />
  <!-- Helpers -->
          ...
          <div class="card-body">
            ...
            <div class="app-brand justify-content-center">
              <a href="index.html" class="app-brand-link gap-2">
                ...
                <span class="demo text-body fw-bolder" style="font-size:35px;">Login</span>
              </a>
            </div>
            <!-- /Logo -->
            <h4 class="mb-2">Welcome to Sistem Monitoring Kendaraan! 👋</h4>
            <p class="mb-4">Please sign-in to your account and start the adventure</p>

            <form id="formAuthentication" class="mb-3" action="<?= base_url('index.php/auth/login') ?>" method="POST">
              <div class="mb-3">
